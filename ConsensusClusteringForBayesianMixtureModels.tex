...
\begin{figure} %[!tpb]
	\centering
	\includegraphics[scale=0.30]{./Images/Simulations/small_n_large_p_base/comp_psms_cm_edited.png}	
...
Additional results are in section 4.4 of the Supplementary Material. %, with an additional 9 scenarios also included.
