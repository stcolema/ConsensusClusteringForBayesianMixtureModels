...
\begin{figure} %[!tpb]
	...
	\label{fig:yeastCMs}
\end{figure}
We performed a Gene Ontology (GO) enrichment analysis of our inferred clusters using the \texttt{Bioconductor} packages \texttt{biomaRt} \citep{durinck2005biomart, durinck2009mapping} and \texttt{clusterProfiler} \citep{yu2012clusterProfiler}. The long chains 
\begin{figure} %[!tpb]
	\centering
...
\begin{figure} %[!tpb]
	...
	\caption{The enriched GO terms disagree across chains.}
